...
As explained in chapter \fullref{subsec:Data sources} our biggest data source is the Fusion \ac{API} of Yelp and
...
The last step, the analysis of the data, was done depending on the scenario with the Bi- and Software Analysis Software Tableau or with a Python Script and the libraries \code{pandas} and \code{matplotlib}.
