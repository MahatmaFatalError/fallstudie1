...
\newline
In \fullref{subsubsec:potential} we found out that the metropolis \textbf{Bochum} has the most potential to get a good rating.
...
As you can see from \fullref{app_fav_items} the favorite dish in Bochum is the \textit{rumpsteak} with a total count of 7.
