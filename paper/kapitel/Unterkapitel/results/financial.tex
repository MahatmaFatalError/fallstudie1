...
The target, mentioned in \fullref{sec:introduction}, is to generate a turnover of 40,000 \euro per month. For this purpose
...
\indent 2. Looking for real estate objects that matching these requirements \\
