...
After checking the trained model on the basis of test data for cross-validation, the already suspected result is confirmed: $ R^2$ of 0.00236 confirms the assumption that crucial independent variables are missing in the data in ordner to achieve proper prediction quality.
\bildWOCite{kapitel/unterkapitel/results/ctree.png}{Unbiased Conditional Inference Tree}{ctree}{}{}
